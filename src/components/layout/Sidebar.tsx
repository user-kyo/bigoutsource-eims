      ...
      <aside className={cn(
        ...
        <div className={cn("py-6", isRetracted ? "px-4" : "px-6")}>
          <div className={cn("flex items-center mb-8 overflow-hidden", isRetracted ? "justify-center" : "gap-2")}>
            ...
            {!isRetracted && <span className="font-bold text-l tracking-tight text-[#111827] whitespace-nowrap">Big Outsource EIMS</span>}
          </div>
              ...
              return (
                ...
                >
                  <div className={cn("flex items-center", isRetracted ? "justify-center" : "gap-3")}>
                    ...
                    {!isRetracted && <span className="text-sm font-medium whitespace-nowrap">{item.label}</span>}
                  </div>
        ...
        <div className={cn("mt-auto border-t border-[#E5E7EB]", isRetracted ? "p-4 space-y-4" : "p-4 space-y-4")}>
          ...
          >
            ...
            {!isRetracted && <span className="text-sm font-medium whitespace-nowrap">Log out</span>}
          </button>
        </div>
      </aside>
